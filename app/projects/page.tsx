...
const projects = [
  {
    ...
    description: "Премиальный клубный квартал бизнес-класса по модели ЖК Estet. 3-4 корпуса до 5 этажей, неоклассическая архитектура, клинкерный кирпич и натуральный камень. Закрытая территория с озеленённым двором, подземный паркинг. Street retail на первых этажах — кафе, коворкинг, аптека.",
    details: [
      ...
      { label: "Архитектура", value: "Неоклассика (по модели ЖК Estet)" },
    ...
    highlight: "Малоэтажный бизнес-класс — дефицит в Алматы. ЖК Estet продаёт квартиры от 1.14 млн тг/м² при 12-16 этажах. Клубный формат до 5 этажей — это премиум-сегмент с ценой 1.2-1.5 млн тг/м² и минимальной конкуренцией.",
  },
  {
    id: "borovoe",
    tag: "Туризм",
